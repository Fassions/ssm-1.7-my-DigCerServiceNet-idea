...
public class ExpressExcel {
    ...
    @ExcelVOAtteribute(name="求和项：数量",column = "N")
    private String productTotalCount;
    //发货单号
    @ExcelVOAtteribute(name="快递单号",column = "O")
    private String expressNo;

    //发货日期
    @ExcelVOAtteribute(name="发货日期",column = "P")
    private String deliveryDate;

    //备注
    @ExcelVOAtteribute(name="发货备注",column = "Q")
    private String expressMessage;

    //导入失败原因
    @ExcelVOAtteribute(name="失败原因",column = "R")
