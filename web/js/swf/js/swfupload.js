...
if (SWFUpload == undefined) {
    SWFUpload = function (settings) {
        ...
        if (fls.f) console.log("已安装flash,当前flash版本为：" + fls.v + ".x");
        else console.log("没有安装flash");
...
SWFUpload.prototype.loadSupport = function () {
    this.support = {
        ...
        loading: swfobject.hasFlashPlayerVersion("1.0.28"),
...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
    ...
    var classid = navigator.userAgent.search(/MSIE/) > -1?' classid="clsid:D27CDB6E-AE6D-11cf-96B8-44553540000" ':' ';
