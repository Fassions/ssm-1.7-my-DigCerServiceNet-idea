(function($) {  
    ...
    $("#mb_box").css({ width: '100%', height: '100%', zIndex: '99999', position: 'fixed',  
      filter: 'Alpha(opacity=60)', backgroundColor: '#666', top: '0', left: '0', opacity: '0.2'  
    });  
   
    $("#mb_con").css({ zIndex: '999999', width: '40%', position: 'fixed',  
    ...
    $("#mb_msg").css({ padding: '20px', lineHeight: '20px', color: '#444',
    ...
    //让提示框居中  
    $("#mb_con").css({ top: (_height*0.8 - boxHeight) / 2 + "px", left: (_widht - boxWidth) / 2 + "px" });  
  }  
